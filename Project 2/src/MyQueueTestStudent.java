...
class MyQueueTestStudent {
	...
	double s1 =1,s2=2,s3=3,s4=4,s5=5;
	...
	@Test
	public void testDequeueDouble() {
		try {
			assertEquals(s1, doubleQ.dequeue());
			assertEquals(s2, doubleQ.dequeue());
			//Queue is empty, next statement should cause QueueUnderFlowException
			doubleQ.dequeue();
			assertTrue(false, "This should have caused an QueueUnderflowException");
		}
	...
	@Test
	public void testEnqueueDouble() {
		try {
			assertEquals(2, doubleQ.size());
			assertEquals(true, doubleQ.enqueue(s3));
			assertEquals(3, doubleQ.size());
			assertEquals(true, doubleQ.enqueue(s4));
