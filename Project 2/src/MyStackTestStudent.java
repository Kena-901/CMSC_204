...
class MyStackTestStudent {
	...
	public void testPopDouble() {
		try {
			assertEquals(s2, doubleS.pop());
			assertEquals(s1, doubleS.pop());
			//Queue is empty, next statement should cause QueueUnderFlowException
			doubleS.pop();
			assertTrue(false, "This should have caused an StackUnderflowException");
		}
	...
	public void testPushDouble() {
		try {
			...
			assertEquals(true, doubleS.push(s3));
			assertEquals(3, doubleS.size());
			assertEquals(true, doubleS.push(s4));
	...
	@Test
	public void testToStringDouble() throws StackOverflowException {
